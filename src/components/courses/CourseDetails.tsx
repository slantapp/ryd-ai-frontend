      ...
      >
        ...
        <div
          className={cn(
            ...
            isLgUp ? "p-3 sm:p-4" : "min-w-0 overflow-hidden",
          )}
        >
          {isLgUp && (
            <>
              ...
              <div className="relative flex w-full min-h-0 flex-1 flex-col overflow-y-auto border-l-0 border-primary/20 bg-linear-to-br from-[#F3ECFE] via-[#F8F4FF] to-white p-4 sm:p-6 lg:min-h-screen lg:border-l-2">
                ...
                <div className="relative z-10">
                  {currentQuestion ? (
                    ...
                    <LessonStartGate
                      className="min-h-[min(100%,22rem)] rounded-none bg-transparent lg:bg-linear-to-br lg:from-[#F3ECFE] lg:via-[#F8F4FF] lg:to-white"
                      heading={
